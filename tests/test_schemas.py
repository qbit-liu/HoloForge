...
class CardSchemaTests(unittest.TestCase):
    ...
    def test_holographic_superconductor_optical_model_card_is_valid(
        self,
    ) -> None:
        card = load_json(
    ...
    def test_hard_wall_model_card_is_valid(self) -> None:
    ...
    def test_gubser_nellore_ed_model_card_is_valid(self) -> None:
