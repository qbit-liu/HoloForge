...
A speculative cross-domain application begins in `incubator/` with a hypothesis
card. It must state the candidate dictionary, prior-work screen, calculable
observable, and a result that would falsify the idea. AI involvement must be
recorded. Explore work cannot be labelled established because code executes.
